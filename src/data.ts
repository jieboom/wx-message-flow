...
export const messageList: Message<MSomeBodyType>[] = [
  ...
  },
  {
    ...
    MBody: {
      ...
      avatar:
        "https://pic1.zhimg.com/v2-bde57fab9bd630124499f584d00c6cd8_b.jpg",
      nickName: "鱼儿",
    },
  },
  {
  ...
  },
  {
    ...
    MBody: {
      isSelf: true,
      picUrl:
        "https://pic3.zhimg.com/v2-363f7bc6155690ab794975215b55463a_r.jpg",
      avatar:
        "http://img01.yohoboys.com/contentimg/2018/11/22/13/0187be5a52edcdc999f749b9e24c7815fb.jpg",
      nickName: "丽丽",
    },
  ...
  },
  {
    ...
    MBody: {
      ...
      subType: "webLink",
      coverUrl:
        "https://img9.doubanio.com/pview/drama_subject_poster/median/public/723b5363ef2d444.jpg",
      title: "贼想得到你",
  ...
  },
  {
    ...
    MBody: {
      content: "周末加我一个",
      avatar:
        "https://img.syt5.com/2020/0828/20200828101353493.jpg.420.420.jpg",
      isSelf: false,
      nickName: "阿杰",
    },
  },
